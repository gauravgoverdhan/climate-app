...
mongoose.connect(
  "mongodb+srv://admin:computermine@cluster0.zqg34.mongodb.net/weatherdb?retryWrites=true&w=majority",
  {
...
app.get("/dashboard", async (req, res) => {
  ...
  const geolocRes = await axios.get(
    "https://geocode.xyz/" +
      city +
      "?json=1&auth=" +
      process.env.GEOCODE_AUTH_KEY
  );
